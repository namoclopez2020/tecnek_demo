			  ...
			  <div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					...
					<th><span class="pull-right">Precio fijo</span></th>
			...
			$fecha_hoy=date('Y-m-d');
				...
				while ($row=$db->fetch_array($query)){
					...
					<tr>
						...
						<td class='col-xs-1'>
						<div class="pull-right">
						<input type="text" class="form-control" id="precio_venta_<?php echo $id_producto; ?>"  value="<?php echo $precio_venta;?>" >						</div></td>
						<td class='col-xs-2'><div class="pull-right">
						<input type="hidden"  id="stock_<?php echo $stock; ?>"  value="<?php echo $stock;?>" >	
						
							<label><?php echo "S/.".$precio_venta;?>
						</label>
						</div></td>
